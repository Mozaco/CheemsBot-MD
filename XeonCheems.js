...
//[target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/HYj9bfhswer6CROxyeQbHoS"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Subscribe Bot's Official YT Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://youtu.be/null"}}}, { quoted: m})
        }
try {
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
	    ...
	    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3ffc8f5e134cf7ff34133.jpg' }, caption: `*Hi bro ${m.pushName}*\n\n Bot Rental Price\n⭔ 250INR Per Group via Gpay/paytm/phonepe 1 Month\n\nFor more details, you can chat with the owner\nhttps://wa.me/436703081866174 (Owner)\n\nDonate Me : \n\n⭔ Fampay : https://telegra.ph/file/3ffc8f5e134cf7ff34133.jpg\n⭔ Paytm : https://telegra.ph/file/3ffc8f5e134cf7ff34133.jpg` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply('Script : Script will be available soon \nInstagram : http://instagram.com/mozaco.zx\n Dont Forget To Follow me')
            }
            break
            case 'chat': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/kingstarstudios/Emilybot-MD'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Owner Number👤',
                                    phoneNumber: '+43-670-3081866174'
                                }
                            }, {
                                quickReplyButton: {
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `EmilyBot-MD`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Instagram',
                                    url: 'http://instagram.com/mozaco.zx'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'Script',
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            locationMessage: {
                            jpegThumbnail: fs.readFileSync('./XeonMedia/cheemspic.jpg')},
                            hydratedFooterText: `Hi bro ${pushname}
How Are You? 😊
